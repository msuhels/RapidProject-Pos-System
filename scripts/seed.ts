  ...
  try {
    ...
    const moduleFieldDefinitions: Record<string, ModuleFieldSeed[]> = {
      ...
      PRODUCTS: [
        ...
        { name: 'Quantity', code: 'quantity', label: 'Quantity', fieldType: 'text', description: 'Product quantity', sortOrder: 3 },
        { name: 'Image', code: 'image', label: 'Image URL', fieldType: 'url', description: 'Product image URL', sortOrder: 4 },
        { name: 'Category', code: 'category', label: 'Category', fieldType: 'text', description: 'Product category', sortOrder: 5 },
      ],
      CARTS: [
